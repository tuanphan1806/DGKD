              ...
              <div class="card">
                ...
                @endif
                  ...
                  <div class="form-group">
                      <label for="filter_id">Chọn bộ lọc</label>
                    ...
                    <div class="form-group">
                      <label for="filter_value">Giá trị bộ lọc</label>
                      <input type="text" class="form-control" id="filter_value" placeholder="Nhập tên bộ lọc" name="filter_value" @if(!empty($filter['filter_value'])) value="{{ $filter['filter_value'] }}" @else value="{{ old('filter_value') }}" @endif>
                    </div>
