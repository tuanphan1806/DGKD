            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Cài đặt mục lục</h3>
                        <h6 class="font-weight-normal mb-0">Cập nhật mục lục</h6>
                    </div>
                ...
                @endif
                  <form class="forms-sample" @if(empty($section['id'])) action="{{ url('admin/add-edit-section') }}" @else action="{{ url('admin/add-edit-section/'.$section['id']) }}" @endif method="post" enctype="multipart/form-data" >@csrf
                    ...
                    <div class="form-group">
                      <label for="section_name">Tên danh mục</label>
                      <input type="text" class="form-control" id="section_name" placeholder="Nhập tên danh mục" name="section_name" @if(!empty($section['name'])) value="{{ $section['name'] }}" @else value="{{ old('section_name') }}" @endif>
                    </div>
