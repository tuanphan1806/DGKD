...
class CategoryController extends Controller
{
    ...
    public function deleteCategoryImage($id)
    {
        ...
        $category_image_path = public_path('front/images/category_images/' . $categoryImage->category_image);
        ...
        // Cập nhật lại DB: xoá đường dẫn ảnh
        Category::where('id', $id)->update(['category_image' => '']);

        return redirect()->back()->with('success_message', 'Xóa hình thành công!');
    }
}
