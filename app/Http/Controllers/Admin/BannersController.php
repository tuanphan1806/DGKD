...
use Intervention\Image\Facades\Image; // Ensure you have this package installed for image manipulation
...
class BannersController extends Controller
{
    ...
    public function deleteBanner($id)
    {
        ...
        $imageFullPath = public_path($banner_image_path . $bannerImage->image);

        // Xoá file nếu tồn tại
        if (!empty($bannerImage->image) && file_exists($imageFullPath)) {
